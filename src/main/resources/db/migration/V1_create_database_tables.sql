...
CREATE TABLE t_desastre (
    ...
    t_localizao_id_localizacao NUMBER NOT NULL
);
...
ALTER TABLE t_desastre
    ADD CONSTRAINT t_desastre_t_localizao_fk FOREIGN KEY (t_localizao_id_localizacao)
        REFERENCES t_localizao (id_localizacao);
